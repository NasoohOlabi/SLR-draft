...
\begin{table}[h]
  ...
  \begin{tabular}{p{4cm} p{9cm}}
    ...
    Proprietary Models (4/25, 16.0\%) &
    GPT-3.5/4, ChatGPT
    \cite{xu2024beyond,steinebach2024natural,wu2024generative,hao2025robust} \\
    Custom or Task-Specific Architectures (4/25, 16.0\%) &
    From-scratch or task-specific models
    \cite{yang2020vae,ding2023joint,ji2024principled,munyer2024deeptextmark} \\
    \hline
  \end{tabular}
  \caption{Representative model families across the 25 studies explicitly enumerated in the current synthesis tables. Categories are non-exclusive, so totals exceed 100\%.}
\end{table}
