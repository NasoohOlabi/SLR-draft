...
Steganography hides the existence of information by embedding it in ordinary carriers (e.g., text, images). The fundamental goal is to achieve \textbf{imperceptibility}, which encompasses three dimensions: \textbf{perceptual imperceptibility} (the steganographic text appears natural and indistinguishable from normal text to human observers), \textbf{statistical imperceptibility} (the statistical properties of the steganographic text match those of the cover medium), and \textbf{cognitive imperceptibility} (the semantic content and contextual coherence remain consistent with expected communication patterns). Text is a challenging carrier due to its low redundancy and strict semantics.
...
\begin{itemize}
    ...
    \item \textbf{Cognitive Imperceptibility}: The property that the semantic content and contextual coherence of steganographic text remain consistent with expected communication patterns and domain-specific knowledge.
    ...
    \item \textbf{Psic Effect}: The Perceptual-Statistical Imperceptibility Conflict Effect, representing the fundamental trade-off where optimizations for perceptual quality may compromise statistical security and vice versa.
\end{itemize}
