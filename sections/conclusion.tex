...
This systematic literature review shows that Large Language Models (LLMs) have substantially expanded the design space of linguistic steganography. Across 26 primary studies, the reviewed literature points to a shift toward generative, rewriting-based, black-box, and context-aware techniques that aim to improve fluency and contextual plausibility while maintaining usable payload.
