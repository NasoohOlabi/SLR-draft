...
\centering
\small
\begin{tabular}{|p{2cm}|p{1.8cm}|p{1.8cm}|p{2.2cm}|p{2.5cm}|p{2.5cm}|}
\hline
\textbf{Method Type} & \textbf{Avg. PPL} & \textbf{Avg. KLD} & \textbf{Avg. Embedding Rate} & \textbf{Human Eval} & \textbf{Trend} \\
\hline
