...
This section presents the synthesized findings from the 32 primary studies included in the systematic literature review. The analysis covers literature through 2025 and is organized around the five research questions (RQs), with a synthesis of trends, quantitative comparisons, and representative examples. The analysis contrasts black-box methods, which use models through interfaces without internal access, with white-box methods, which require access to model internals.
