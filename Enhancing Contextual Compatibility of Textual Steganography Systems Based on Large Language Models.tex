...
\documentclass[sigconf]{sections/acmart} % Remove 'review' option
...
\input{sections/llm_approaches.tex} % This will be '2. Steganography and Large Language Models'
\input{sections/study_design.tex} % This will be '3. Literature review methodology'
\input{sections/search_conducting.tex}
\input{sections/data_extraction.tex}
\input{sections/data_synthesis.tex}
