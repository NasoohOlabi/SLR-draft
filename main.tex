...
\input{llm_approaches.tex} % This will be '2. Steganography and Large Language Models'
\input{study_design.tex} % This will be '3. Literature review methodology'
\input{search_conducting.tex}
\input{data_extraction.tex}
\input{data_synthesis.tex}
\input{results.tex} % This will be '4. LLM-based Steganography Approaches'
\input{generated_tables.tex}
\input{background.tex} % This will be '5. Context awareness' (content needs to be adapted)
